@if (Session::has('success'))
	<div class="alert alert-success myWrap mt-4" role="alert">
...
@if (Session::has('failure'))
	<div class="alert alert-danger myWrap mt-4" role="alert">
...
@if (session()->has('msgs'))
	<div class="alert alert-info myWrap mt-4" role="alert">
		<strong>Note:</strong>
		<ul>
...
@if(session()->has('msgx'))
	@if(array_key_exists('failure', Session::get('msgx')))
		<div class="alert alert-danger myWrap mt-4" role="alert"><strong>Error:</strong><ul>
	...
	@if(array_key_exists('warning', Session::get('msgx')))
		<div class="alert alert-warning myWrap mt-4" role="alert"><strong>Warning:</strong><ul>
	...
	@if(array_key_exists('success', Session::get('msgx')))
		<div class="alert alert-success myWrap mt-4" role="alert"><strong>OK:</strong><ul>
	...
	@if(array_key_exists('primary', Session::get('msgx')))
		<div class="alert alert-primary myWrap mt-4" role="alert"><strong></strong><ul>
	...
	@if(array_key_exists('secondary', Session::get('msgx')))
		<div class="alert alert-secondary myWrap mt-4" role="alert"><strong></strong><ul>
	...
	@if(array_key_exists('info', Session::get('msgx')))
		<div class="alert alert-info myWrap mt-4" role="alert"><strong>Info:</strong><ul>
	...
	@foreach(array_diff_key(Session::get('msgx'), ['failure'=>'', 'warning'=>'', 'success'=>'', 'primary'=>'', 'secondary'=>'', 'info'=>'']) as $type => $msgs)
		<div class="alert alert-dark myWrap mt-4" role="alert"><strong>{{ $type }}:</strong><ul>
