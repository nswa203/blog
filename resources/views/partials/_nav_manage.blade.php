<div id="sidebar-wrapper">
    <ul class="sidebar-nav">
        ...
        <li><a href="{{ route('folders.index')      }}" class="{{ Request::is('manage/folders*'     )?'active':'' }}"><span class="fas fa-folder-open   mr-3"></span>Manage Folders</a></li>
        <li><a href="{{ route('files.index')        }}" class="{{ Request::is('manage/files*'       )?'active':'' }}"><span class="fas fa-folder        mr-3"></span>Manage Files</a></li>
