...
@section('content')
	<div class="row">
		<div class="col-md-8">
			<h1><a id="menu-toggle2"><span class="fas fa-user-plus mr-4"></span>Create New Role</a></h1>
			<hr>
		...
		<div class="col-md-4">
			<div class="card card-body bg-light">
				...
				<div id="app2"> <!-- Vue 2 -->
					<dt>
						{{ Form::radio('permission_type', 'basic', null, ['class'=>'mr-2', 'v-model'=>'permissionType']) }}
						{{ Form::label('permission_type1', 'Basic Permission:',	['class'=>'']) }}
					</dt>
					<dt>
						{{ Form::radio('permission_type', 'crud', null, ['class'=>'mr-2', 'v-model'=>'permissionType']) }}
						{{ Form::label('permission_type2', 'CRUD Permission:', ['class'=>'']) }}
					</dt>
					<hr class="hr-spacing-top mt-2">

					<div v-if="permissionType == 'crud'">
						<dt>
							{{ Form::checkbox('custom-value', 'create', null,['class'=>'', 'v-model'=>'crudSelected']) }}
							{{ Form::label('custom-value', 'Create', ['class'=>'ml-2']) }}
						</dt>
						<dt>		
							{{ Form::checkbox('custom-value', 'read', null, ['class'=>'', 'v-model'=>'crudSelected']) }}
							{{ Form::label('custom-value', 'Read', ['class'=>'ml-2']) }}
						</dt>
						<dt>
							{{ Form::checkbox('custom-value', 'update', null,['class'=>'', 'v-model'=>'crudSelected']) }}
							{{ Form::label('custom-value', 'Update', ['class'=>'ml-2']) }}
						</dt>
						<dt>		
							{{ Form::checkbox('custom-value', 'delete', null, ['class'=>'', 'v-model'=>'crudSelected']) }}
							{{ Form::label('custom-value', 'Delete', ['class'=>'ml-2']) }}
						</dt>
						<hr class="hr-spacing-top mt-2">
					</div>
				</div> <!-- Vue 2 -->	
