...
@section('content')
	<div class="row">
		<div class="col-md-8">
			...
			{!! Form::model($profile, ['route'=>['profiles.update', $profile->id], 'method'=>'PUT', 'data-parsley-validate'=>'', 'files'=>true]) !!}
			
				{{ Form::label('user_id','Registered User:', ['class'=>'font-bold form-spacing-top']) }}
				{{ Form::select('user_id', $users, null, ['class'=>'form-control custom-select', 'disabled']) }}
