...
@section('content')
	@if ($files)
		{!! Form::open(['route'=>'files.manyMove', 'data-parsley-validate'=>'']) !!}
		...
		<div class="row">
			...
			<div class="col-md-2 mt-2">
				{{ 	Form::button('<i class="fas fa-forward mr-2"></i>YES MOVE NOW', ['type'=>'submit', 'class'=>'btn btn-primary btn-block']) }}
			</div>
